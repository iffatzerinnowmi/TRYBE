...
use App\Http\Controllers\StudyCompletionController;
...
Route::middleware(['auth', 'role:participant'])->prefix('participant')->name('participant.')->group(function () {
    ...
    Route::post('/studies/{study}/complete', [StudyCompletionController::class, 'request'])
        ->name('studies.complete.request');
});
...
Route::middleware(['auth', 'role:researcher'])->prefix('researcher')->name('researcher.')->group(function () {
    ...
    Route::post('/studies/{study}/invite/{participant}', [StudyInvitationController::class, 'store'])
        ->name('studies.invite');
    // FEATURE — Participant Free-to-Paid Unlock Rule (Member 3)
    Route::post('/studies/{study}/participants/{participant}/approve', [StudyCompletionController::class, 'approve'])
        ->name('studies.participants.approve');
    Route::post('/studies/{study}/participants/{participant}/decline', [StudyCompletionController::class, 'decline'])
        ->name('studies.participants.decline');
